...
{
    cashTill[0] = registerDailyStartingCash[0, 1]; // 50
    cashTill[1] = registerDailyStartingCash[1, 1]; // 20
    cashTill[2] = registerDailyStartingCash[2, 1]; // 10
    cashTill[3] = registerDailyStartingCash[3, 1]; // 5
}
